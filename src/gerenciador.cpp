 ...
 * @brief Implementação do gerenciador.
...
/**
 * @brief Menu com as opções do programa
 * @details Nessa função são mostradas opções as quais levam aos métodos que irão fazer o 
 descrito na opção escolhida.
 */
void Gerenciador(){
